...
export const DEFAULT_CONFIG = {
  GATEWAY_URL: 'http://localhost:8000/api/v1', // Configure your AI Guardians gateway endpoint
  API_KEY: '', // Set your API key in options
  GUARD_SERVICES: {
    ...
    contextguard: { enabled: false, threshold: 0.6, displayName: 'Context Analysis' },
    securityguard: { enabled: false, threshold: 0.8, displayName: 'Security Analysis' },
    tokenguard: { enabled: false, threshold: 0.5, displayName: 'Token Optimization' },
    healthguard: { enabled: false, threshold: 0.5, displayName: 'Health Monitoring' }
  },
  LOGGING_CONFIG: {
    level: 'info',
