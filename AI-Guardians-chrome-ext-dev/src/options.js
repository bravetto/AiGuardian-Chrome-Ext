...
(function(){
  ...
  function populateGuardServices() {
    ...
    const defaultGuards = {
      biasguard: { enabled: true, threshold: 0.5, name: 'Bias Detection' },
      trustguard: { enabled: true, threshold: 0.7, name: 'Trust Analysis' },
      contextguard: { enabled: false, threshold: 0.6, name: 'Context Analysis' },
      securityguard: { enabled: false, threshold: 0.8, name: 'Security Analysis' },
      tokenguard: { enabled: false, threshold: 0.5, name: 'Token Optimization' },
      healthguard: { enabled: false, threshold: 0.5, name: 'Health Monitoring' }
    };
